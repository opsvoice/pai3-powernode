        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <button className="border-2 border-[#32f932] text-[#32f932] py-4 rounded-xl text-lg font-bold hover:bg-[#32f932]/10 transition-all">
                  Learn More
                </button>
              </div>
              ...
              <div className="text-center">
                <button className="text-[#32f932] hover:text-[#32f932]/80 transition-colors text-sm underline">
                  See ROI Calculator
                </button>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="border-2 border-[#32f932] text-[#32f932] px-8 py-4 rounded-xl text-lg font-bold hover:bg-[#32f932]/10 transition-all">
                See ROI Calculator
              </button>
            </div>
          </motion.div>
...
export default NodeTypesStandalone;