      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-2xl text-white max-w-4xl mx-auto">
            ...
            where <span className="text-green-400">you own your intelligence.</span>
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gray-900 border border-green-500/30 rounded-3xl p-12 max-w-4xl mx-auto">
            <h3 className="text-3xl font-bold mb-6 text-white">The PAI3 Difference</h3>
            <div className="grid md:grid-cols-2 gap-8 text-left">
              <div>
                <h4 className="text-xl font-semibold text-green-400 mb-3">Big Tech AI</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-green-400 mb-3">PAI3 Network</h4>
                <ul className="space-y-2 text-white">
